        ...
        >
          <div className="w-full flex justify-between items-center">
            ...
            <div className="flex justify-between items-center gap-2">
              ...
              {index !== 0 && (
                <div
                  className="w-6 h-6 bg-rose-faux rounded-sm flex justify-center items-center shadow-[0_2px_8px_0_rgb(33,36,39,0.12)]"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-6 w-full ">
            <div className="w-full h-12 rounded-lg shadow-[0_1px_4px_0_rgb(33,36,39,0.04)] px-4 py-[13px] border border-gray-300">
              <input
                className="outlinen-none w-full"
                placeholder="Name f the organization"
                type="text"
              />
            </div>
            <div className="w-full h-12 rounded-lg shadow-[0_1px_4px_0_rgb(33,36,39,0.04)] px-4 py-[13px] border border-gray-300">
